"""
Filecollector return Vector("file_path")
"""
function filecollector(begin_dir::String; 
		detect_exts::Union{Nothing, Vector{String}} = nothing, 
		ignore_exts::Union{Nothing, Vector{String}} = nothing)
    # error handling
...
function filepicker(target_files::Vector{String}, searchStrs::Union{Nothing, Vector{String}, Vector{Regex}})
